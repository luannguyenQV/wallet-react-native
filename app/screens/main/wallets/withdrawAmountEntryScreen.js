...
class WithdrawAmountEntryScreen extends Component {
  ...
  withdrawConfirmed = async () => {
    ...
    let responseJson = await TransectionService.withdraw(
      amount,
      ...
      Alert.alert('Success', 'Transaction successful', [
        {
          text: 'OK',
          onPress: () =>
            ResetNavigation.dispatchToSingleRoute(
...
export default WithdrawAmountEntryScreen;
